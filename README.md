...
![Radar Output](assets/output.png)
...
## ⚠️ Important Notes
1. Ensure both Arduino and Processing use the same baud rate
2. Update COM port according to your system
3. Keep serial monitor closed while running Processing

---

## 🔮 Future Improvements
1. Add wireless communication (Bluetooth / WiFi)
2. Improve UI with better graphics
3. Increase detection accuracy
4. Integrate with mobile or web dashboard

---

## 👨‍💻 Author
Kavyansh Jain
B.Tech CSE | BIT Mesra | AIML | Data Science | IOT
